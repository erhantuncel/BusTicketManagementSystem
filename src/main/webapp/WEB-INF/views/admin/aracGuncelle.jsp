	       			...
	       			<div class="box-body">
			          	<form class="form-horizontal">
			          		<div class="form-group">
								<label for="vehicleId" class="col-sm-2 control-label">Araç No</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="vehicleId"  disabled>
								</div>
								<!-- /.input group -->
							</div>
			          		<div class="form-group">
							...
							<div class="form-group">
								<label for="seatCounts" class="col-sm-2 control-label">Koltuk Miktarý</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="seatCounts">
								</div>
								<!-- /.input group -->
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-4">
									<button type="submit" class="btn btn-success btn-flat">Araç Güncelle</button>
								</div>
							</div>
						</form>   			
	       			</div>
