				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-primary">
							...
							<div class="box-body">
								<form:form class="form-horizontal" modelAttribute="updateCustomerForm" action="${home}/musteri/bilgiGuncelle" method="POST">
									...
									<div class="form-group">
										<div class="col-sm-offset-2 col-sm-4">
											<button type="submit" class="btn btn-primary btn-flat">Müþteri Güncelle</button>
										</div>
									</div>
								</form:form>  
							</div>
